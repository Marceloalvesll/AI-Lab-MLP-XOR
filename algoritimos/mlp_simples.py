...
if __name__ == "__main__":
    ...
    #TESTE QUE VEIO NO CODIGO DO PROFESSOR
    ...
    #nn = NeuralNetwork(input_size=2, hidden_sizes=[2], output_size=1, learning_rate=0.1, epochs=1000)
     ...
     # segundo  TESTE
    #nn = NeuralNetwork(input_size=2, hidden_sizes=[4], output_size=1, learning_rate=0.01, epochs=5000)

    # terceiro TESTE
    nn = NeuralNetwork(input_size=2, hidden_sizes=[4], output_size=1, learning_rate=0.5, epochs=10000)

    # quarto TESTE
    #nn = NeuralNetwork(input_size=2, hidden_sizes=[4], output_size=1, learning_rate=0.5, epochs=5000)

     # quinto TESTE
    #nn = NeuralNetwork(input_size=2, hidden_sizes=[2], output_size=1, learning_rate=0.05, epochs=5000)

    # sexto TESTE
    #nn = NeuralNetwork(input_size=2, hidden_sizes=[6], output_size=1, learning_rate=0.1, epochs=5000)
